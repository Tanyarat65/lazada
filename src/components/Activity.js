...
export default function Activity() {
    ...
    return (
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-5 px-6 justify-center items-center'>
            {activityButton.map(item => (
                <div key={item.id} className='flex items-center pl-3 py-3 gap-4 shadow rounded-full bg-white w-auto cursor-pointer'>
